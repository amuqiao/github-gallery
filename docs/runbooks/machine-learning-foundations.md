...
- 讲具体模型、论文、开源项目或工程系统；这些内容优先使用模型、工具、开源项目或 AI 工程系统类提示词。
...
- [风格模板.md](../prompts/一文读懂/风格模板.md)
- 本文对应专题的追加要求

涉及最小代码、框架 API、训练排错或方案选型时，追加：

- [工程实现与方案选型补充提示词.md](../prompts/一文读懂/工程实现与方案选型补充提示词.md)

某一篇如果聚焦具体算法，例如单独讲 SGD、Adam、Backpropagation 作为算法过程，而不是讲概念体系，可以改用：

- [算法提示词模板-一文读懂版.md](../prompts/一文读懂/算法提示词模板-一文读懂版.md)

使用时先复制基础模板，再复制风格模板和工程补充模板，最后追加对应专题要求。
...
- 如果某个专题需要大量框架 API、真实训练脚本或方案选型，追加工程实现补充提示词；如果只是解释概念，不强行加入代码。
