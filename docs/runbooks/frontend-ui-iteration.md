...
3. Button、Badge、Card、EmptyState 这类通用样式改 `src/components/ui/`。
4. ProjectCard、FilterPanel、ProjectHero 这类业务展示改 `src/components/`。
5. 页面只调整组件顺序和 props，不堆复杂 Tailwind class。
